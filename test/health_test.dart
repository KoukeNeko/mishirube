...
void main() {
  group('nights from samples', () {
    ...
    test('bed after midnight and an afternoon nap belong to that day', () {
      final nights = nightsOf([
      ...
      expect(nights.map((night) => night.morning), [
        DateTime(2026, 9, 21),
        DateTime(2026, 9, 22),
      ]);
      expect(nights.first.asleep, const Duration(hours: 7, minutes: 30));
    });
  });
