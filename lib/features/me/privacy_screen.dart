    ...
    return DetailPage(
      ...
      children: [
        ...
        const _Section(
          ...
          lines: [
            '預設不使用 AI。沒選之前什麼都不送出。',
            'Apple Intelligence 在手機上執行，資料不離開這支手機。',
            '雲端 AI 只送出你打的文字，或從照片辨識出的文字。',
            '其他紀錄與健康資料不送出。',
            '第一次送出前會先問你，之後在「我的 > AI」可以撤回。',
            'Google AI Studio 的免費額度會把送出的內容用於改進 Google 的產品，可能由人工審閱。',
            '掃描營養標示時，照片在手機上辨識文字，送出的是文字，不是照片。',
            'AI 只產生草稿，確認之後才記錄。',
          ],
        ),
        const _Section(
          title: '金鑰、匯出與備份',
          lines: [
            'API 金鑰存在系統的安全儲存區（iPhone 鑰匙圈、Android Keystore），'
                '不進資料庫，也不隨匯出離開。',
            '只有你按下「我的 > 匯出」才會產生檔案，存在 App 自己的資料夾，不上傳。',
          ],
        ),
      ],
    );
