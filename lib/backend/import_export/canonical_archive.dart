...
const _tables = [
  ...
  _Table('foods', 'foods', [
    ...
    _Column('barcode', _Kind.text, isNullable: true),
    ..._entity,
  ], orderBy: 'id'),
  ...
  _Table('sleepEntries', 'sleep_entries', [
    ...
    _Column('measure', _Kind.text),
    _Column('source_name', _Kind.text),
    _Column('chosen_source', _Kind.text, isNullable: true),
    ..._lived,
    ..._entity,
  ], orderBy: 'id'),
  _Table('sleepSegments', 'sleep_segments', [
    _Column('id', _Kind.text),
    _Column('sleep_id', _Kind.text),
    _Column('started_at', _Kind.time),
    _Column('ended_at', _Kind.time),
    _Column('stage', _Kind.text),
    _Column('native_stage', _Kind.text),
    _Column('recorded_by', _Kind.text),
    _Column('recorded_by_name', _Kind.text),
    _Column('is_manual', _Kind.boolean),
    ..._entity,
  ], orderBy: 'id'),
  _Table('sleepReadings', 'sleep_readings', [
    _Column('id', _Kind.text),
    _Column('sleep_id', _Kind.text),
    _Column('measure', _Kind.text),
    _Column('minimum', _Kind.real),
    _Column('maximum', _Kind.real),
    _Column('average', _Kind.real),
    _Column('sample_count', _Kind.integer),
    _Column('is_elevated', _Kind.boolean, isNullable: true),
    ..._entity,
  ], orderBy: 'id'),
