...
C = {
    ...
    'dumbbell-bent-over-row': ('俯身啞鈴划船', '啞鈴划船', 'la', 'ub rd bi', 'hpl', 'b', 'row'),
    ...
    # 二頭與前臂
    'bicep-curl': ('啞鈴彎舉', '二頭彎舉 二頭肌彎舉 啞鈴二頭彎舉 啞鈴二頭肌彎舉', 'bi', 'fa', 'iso', 'b', 'curl'),
    'hammer-curl': ('錘式彎舉', '槌式彎舉 啞鈴錘式彎舉 啞鈴槌式彎舉', 'bi', 'fa', 'iso', 'b', 'hammer-curl'),
    ...
    'wrist-curl': ('腕彎舉', '手腕彎舉 腕屈 啞鈴腕彎舉', 'fa', '', 'iso', 'b', 'wrist-curl'),
    'wrist-extension': ('反向腕彎舉', '反握手腕彎舉 腕伸 反握腕彎舉 反向啞鈴腕彎舉 啞鈴反向腕彎舉', 'fa', '', 'iso', 'b', 'wrist-curl'),
